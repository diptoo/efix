<link rel="stylesheet" href="http://localhost/efix/assets/css/form.css" rel="stylesheet">

<?php echo form_open_multipart('users/register/' . $iid); ?>

<!-- FROM HERE -->
<div style="width: 100%; margin: 25px;"></div>
<h2 style="text-align: center; color: white; border-bottom: 2px solid #aaa; width: 130px; margin: auto;">Sign UP</h2>
<div style="width: 40%; margin: auto; background-color: #252835; top: 0;">
    <div style="width: 100%; background-color: #252835">
        <!--  UPTO THIS -->
