    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav justify-content-end d-flex flex-fill">
            <li class="nav-item active">
                <a class="nav-link GugiFont"
                   href="<?php echo base_url(); ?>users/myprofile"><?php echo $this->session->userdata('email') ?>&nbsp;&nbsp;&nbsp;<span
                            class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="navbar-brand GugiFont" href="#">0<img src="http://localhost/efix/assets/images/noti3.png"
        ...
        <nav class="col-sm-2 navbar-expand-lg d-none d-md-block sidebar-sticky bg-light sidebar navbar_border">
            <div class="navbar-collapse sidebar-sticky">
                <ul class="nav navbar-collapse flex-column">
                    <li class="nav-item active">
                        <a class="nav-link GugiFont" href="<?php echo base_url(); ?>users/myprofile">My Account<span
                                    class="sr-only">(current)</span></a>
                    </li>
